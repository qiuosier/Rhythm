...
def timeline(request):
    xml_urls = [
        'https://gitlab.oit.duke.edu/davelab/who_webform/commits/QiuFeature.atom?private_token=-ybexNvpDEgNsexMvRMo',
        'https://gitlab.oit.duke.edu/davelab/who_webform/commits/QiuTest.atom?private_token=-ybexNvpDEgNsexMvRMo',
        'https://gitlab.oit.duke.edu/davelab/who_webform/commits/master.atom?private_token=-ybexNvpDEgNsexMvRMo',
    ]
    branches = []
    commits = []
    master_branch = None
